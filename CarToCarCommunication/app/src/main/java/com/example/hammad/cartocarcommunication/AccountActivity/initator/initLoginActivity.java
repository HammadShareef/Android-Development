...
public class initLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void Login() {
        ...
        firebaseAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                {
                    finish();
                    Toast.makeText(initLoginActivity.this,"Successfully Sign in to your account",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), initMapsActivity.class));
                }
                else {
                    Toast.makeText(initLoginActivity.this,"SignIn unsucessfull",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
